        ...
        <?php if (count($carritoData) > 0): ?>
            ...
            <div class="cart-summary">
                ...
                <button class="comprar-btn" onclick="abrirModal()">
                    <i class="fas fa-shopping-bag"></i> Proceder a Pagar
                </button>
            </div>
        <?php else: ?>
            <div class="empty-cart">
                ...
                <a href="Imprenta Cisneros.php" class="continue-shopping-btn">
    ...
    <div class="modal-content">
        ...
        <form action="procesar_compra.php" method="POST">
            ...
            <div class="modal-footer">
                ...
                <button type="submit" class="modal-btn btn-confirm">Confirmar compra</button>
            </div>
        </form>
    </div>
</div>
