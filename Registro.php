...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($verificar->num_rows > 0) {
        ...
        if ($stmt->execute()) {
            ...
            header("Location: Imprenta Cisneros.php");
            exit();
        } else {
...
<body>
        ...
        <div class="register-container">
            ...
            <form method="POST" action="Registro.php" id="registerForm">
                ...
                <div class="form-group">
                    ...
                    <span class="error" id="passwordError">La contraseña debe tener entre 6 y 8 caracteres, al menos un número, una letra y un símbolo (@ - _ .)</span>
                </div>
    ...
    <script>
        function validateForm() {
            ...
            const passwordRegex = /^(?=.*[A-Za-z])(?=.*\d)(?=.*[@\-_.])[A-Za-z\d@\-_.]{6,8}$/;
